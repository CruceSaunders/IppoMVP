        ...
        VStack(alignment: .leading, spacing: AppSpacing.md) {
            ...
            HStack(spacing: AppSpacing.md) {
                ...
                Image(pet.currentImageName)
                    ...
                    .overlay(
                        Circle()
                            .stroke(AppColors.forPet(pet.petDefinitionId), lineWidth: 3)
                    )
                ...
                VStack(spacing: AppSpacing.lg) {
                    ...
                    VStack(spacing: AppSpacing.md) {
                        Image(pet.currentImageName)
                            ...
                            .overlay(
                                Circle()
                                    .stroke(AppColors.forPet(pet.petDefinitionId), lineWidth: 4)
                            )
                            .shadow(color: AppColors.forPet(pet.petDefinitionId).opacity(0.5), radius: 10)
