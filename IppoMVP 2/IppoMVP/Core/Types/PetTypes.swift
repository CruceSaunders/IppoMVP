...
struct GamePetDefinition: Identifiable, Codable, Equatable {
    ...
    var emoji: String {
        switch id {
        case "pet_01": return "🐉"  // Astravyrn - celestial dragon
        case "pet_02": return "🌊"  // Solarok - aquatic titan
        case "pet_03": return "🌿"  // Azyrith - verdant spirit
        case "pet_04": return "🦌"  // Cosmoose - celestial moose
        case "pet_05": return "🌑"  // Nebulyth - abyssal creature
        case "pet_06": return "✨"  // Lumirith - radiant being
        case "pet_07": return "🦄"  // Flitfoal - abyssal creature
        case "pet_08": return "🦎"  // Kryonith - verdant beast
        case "pet_09": return "🔥"  // Emberhart - infernal stag
        case "pet_10": return "🦅"  // Aurivern - radiant phoenix
        default: return "🐾"
        }
    }
}
